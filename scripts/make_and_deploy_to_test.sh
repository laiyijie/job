...
sudo ln -s /opt/job-admin/job-admin-1.0-SNAPSHOT.jar /etc/init.d/job-admin
sudo ln -s /opt/job-executor/job-executor-1.0-SNAPSHOT.jar /etc/init.d/job-executor
